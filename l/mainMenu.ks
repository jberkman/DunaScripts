...
lib:add({
	...
	set mnu:addButton("Execute Manouvre"):onClick to{set choice to 30.}.
	set mnu:addButton("Execute Manouvre (Warp)"):onClick to{set choice to 31.}.
	...
	until choice<0{
		...
		else if choice=30 or choice=31 use("/l/execNode.ks")(stk,mnu,choice=31).
